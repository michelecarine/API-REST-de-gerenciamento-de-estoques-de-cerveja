...
public class BeerControllerTest {
    ...
    @Test
    void whenPATCHIsCalledToIncrementQuantityThenOKstatusIsReturned() throws Exception {
    ...
    @Test
	void whenPATCHIsCalledToIncrementQuantityGreatherThanMaxThenBadRequestStatusIsReturned() throws Exception {
		QuantityDTO quantityDTO = QuantityDTO.builder().quantity(45).build();
    ...
    @Test
	void whenPATCHIsCalledToIncrementQuantityThatBeerNoExistsThenNotFoundStatusIsReturned() throws Exception {
	...
	void whenPATCHIsCalledToDecrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
		QuantityDTO quantityDTO = QuantityDTO.builder().quantity(20).build();
